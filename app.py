#https://github.com/sknetworks20250226/wine-ai.git
...
with col1:
    ...
    user_prompt = st.text_input('프롬프트를 입력하세요', '이 요리에 어울리는 와인을 추천해 주세요')
with col2:
    if uploaded_image:
        st.image(uploaded_image, caption = '업로드 된 요리 이미지', use_container_width=True)
